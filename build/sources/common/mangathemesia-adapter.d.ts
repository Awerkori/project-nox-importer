...
export declare class MangaThemesiaAdapter implements SourceAdapter {
    ...
    constructor(options: MangaThemesiaOptions, rateLimiter?: HostRateLimiter, transport?: typeof fetch);
