...
export function getYugabytePool(): pg.Pool {
  ...
  pool = new pg.Pool({
    ...
    max: cfg.DIRECT_DB_POOL_MAX || parseInt(process.env.DIRECT_DB_POOL_MAX || '2', 10),
...
export async function recoverStalledLeasesDirect(staleGraceSeconds: number = 30): Promise<{
