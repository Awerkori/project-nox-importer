...
export const DEFAULT_MANGOTOONS_ENC_KEY =
  process.env.MANGOTOONS_ENC_KEY || 'abmPisXlFjOLVTnYhbYQTpkWJtOGKwVttzLqstfjRBNVaEtQYG';
 ...
 */
export function decryptMangoPayload(
  payload: string,
  keyString: string = DEFAULT_MANGOTOONS_ENC_KEY,
  salt: string = DEFAULT_MANGOTOONS_SALT
): any {
