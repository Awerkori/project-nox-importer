...
export class MegaHentaiAdapter implements SourceAdapter {
  readonly id = 'megahentai';
  readonly name = 'MegaHentai';
  readonly baseUrl = 'https://megahentai.biz';

  private logger = new Logger('MegaHentaiAdapter');
