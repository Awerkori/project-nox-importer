...
async function main() {
  console.log('======================================================================');
  console.log('Setting MAX_CONCURRENT_CHAPTERS = 5 on Discloud and rebuilding...');
  console.log('======================================================================\n');
  ...
  try {
    ...
    console.log('[1/3] Navigating to Discloud env page...');
    ...
    console.log('Pasting env content with MAX_CONCURRENT_CHAPTERS=5...');
    ...
    for (let attempt = 1; attempt <= 10; attempt++) {
      ...
      const runnerPool5Logged = lines.some(l => l.includes('shared chapter runner pool (5 slots'));

      if (directModeLogged && runnerPool5Logged) {
        console.log('\n✅ DIRECT RUNTIME AND 5 RUNNER SLOTS CONFIRMED ON DISCLOUD!');
        break;
      }
