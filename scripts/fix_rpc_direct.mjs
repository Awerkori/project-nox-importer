...
BEGIN
  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ( SELECT q1.id, q1.task_type, q1.priority, q1.payload, q1.chapter_sort_key, q1.created_at
        ...
        ORDER BY q1.priority DESC, q1.next_run_at ASC LIMIT 15 )
        UNION ALL
        ( SELECT q2.id, q2.task_type, q2.priority, q2.payload, q2.chapter_sort_key, q2.created_at
        ...
        ORDER BY q2.priority DESC, q2.next_run_at ASC LIMIT 15 )
        UNION ALL
        ( SELECT q3.id, q3.task_type, q3.priority, q3.payload, q3.chapter_sort_key, q3.created_at
        ...
        ORDER BY q3.priority DESC, q3.next_run_at ASC LIMIT 15 )
        UNION ALL
        ( SELECT q4.id, q4.task_type, q4.priority + 5000 as priority, q4.payload, q4.chapter_sort_key, q4.created_at
        ...
        ORDER BY q4.chapter_sort_key ASC LIMIT 20 )
      ) cand_batch
      ORDER BY
